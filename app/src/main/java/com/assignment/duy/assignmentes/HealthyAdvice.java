...
public class HealthyAdvice extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.BMIButton).setOnClickListener(new View.OnClickListener(){
            @Override
    ...
    public void CalculateBMIResult ()
    {
        ...
        double heightd = parseDouble(heights);
        String weights = weight.getText().toString();
        double weightd = parseDouble(weights);
        double BMI = weightd / (heightd * heightd);
        System.out.print("\nThe Body Mass Index (BMI) is " + BMI + " kg/m2");
        if (BMI < 18.5) {
            System.out.println("You are Underweight: being underweight is defined as having a body mass index (BMI) below 18.5. This is estimated to be less than the body mass needed to sustain optimal health." +
        ...
        if ((BMI >= 18.5) && (BMI <= 24.9)) {
            System.out.println("Congratulations, you have an ideal BMI that healthy person needs, let's keep your fitness:" +
        ...
        if ((BMI >= 25) && (BMI <= 29.9)) {
            System.out.println("You are overweight:eating excess calories leads to weight gain" +
        ...
        if ((BMI >= 30) && (BMI <= 40)) {
            System.out.println("Warning, you are now obese:abnormal or excessive fat accumulation that presents a risk to health.\n " +
